...
<minecraft:iron_sword>.maxDamage = 150;
...
<minecraft:iron_hoe>.maxDamage = 175;

//<minecraft:golden_pickaxe>.maxDamage = 1;
//<minecraft:golden_sword>.maxDamage = 1;
<minecraft:golden_helmet>.maxDamage = 40;
<minecraft:golden_chestplate>.maxDamage = 50;
<minecraft:golden_leggings>.maxDamage = 50;
<minecraft:golden_boots>.maxDamage = 50;
...
<minecraft:iron_sword>.addTooltip(format.green("Seems to have less durability than usual.."));
...
<minecraft:iron_hoe>.addTooltip(format.green("Seems to have less durability than usual.."));

//<minecraft:golden_sword>.addTooltip(format.green("THIS IS FOR CRAFTING ONLY"));
<minecraft:golden_helmet>.addTooltip(format.green("Seems to have less durability than usual.."));
<minecraft:golden_chestplate>.addTooltip(format.green("Seems to have less durability than usual.."));
<minecraft:golden_leggings>.addTooltip(format.green("Seems to have less durability than usual.."));
<minecraft:golden_boots>.addTooltip(format.green("Seems to have less durability than usual.."));
